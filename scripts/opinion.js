import {appendAddNews, appendMainNews, appendTrendingNews } from "./data.js";
...
const latestData = async() => {
    ...
    try{
     ...
     let res = await fetch('https://newsapi.org/v2/everything?q=opinion&apiKey=de829986749e4d2b88a27db3a10d200e');
